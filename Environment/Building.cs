...
namespace Binder.Environment
{
    ...
    public class Building : WorldObject, ISerialization<Building>
    {
        ...
        {
            new int[4] {-3105, -1380, 69, 6210},
            new int[4] {-3105, 2138, 69, 6210},
            new int[4] {-3105, -1380, 3518, 69},
            new int[4] {3105, -1380, 3518, 69},
        };
        ...
        public static List<int[]> Maze = new List<int[]>()
        {
           ...
           new int[4] {141, 612, 69, 1104},
           new int[4] {621, 612, 414, 69 },
           new int[4] {621, 1095, 69, 828},
           new int[4] {2208, 1242, 690, 69},    //55
